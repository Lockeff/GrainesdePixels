...
window.translations = {
  fr: {
    ...
    'news4-p': `Le projet <strong>Deux Etoiles sont nées</strong> a poursuivi sa route. Et cette route mène à une démo du jeu, actuellement en cours de test avec nos testeurs QA. Plus d'infos : <a href="https://2etoiles.com" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;color: #e09eff;">https://2etoiles.com</a>`,
    ...
    'project-2etoiles-name': '2 étoiles sont nées (en dev)',
    ...
    'project-kelch-name': "Kelc'h AR Viya (concept)",
  ...
  en: {
    ...
    'news4-title': 'May 2026: where are we now?',
    'news4-p': `The project <strong>Two Stars Were Born</strong> has continued its journey. And that journey now leads to a game demo, currently being tested with our QA testers. More info: <a href="https://2etoiles.com" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;color: #e09eff;">https://2etoiles.com</a>`,
    ...
    'project-2etoiles-name': '2 étoiles sont nées (in dev)',
